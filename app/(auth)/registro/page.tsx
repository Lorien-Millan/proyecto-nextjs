...
export default function RegistroPage() {
  ...
  // 🔹 NUEVO: Función para registro/login con Google
        ...
        <div className="bg-white rounded-2xl shadow-2xl p-8 border-t-4" style={{ borderColor: 'var(--color-rosa-principal)' }}>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
              ...
              className="cursor-pointer font-heading w-full py-3 px-4 rounded-lg font-bold text-white transition-all transform hover:scale-[1.02] disabled:opacity-50 disabled:cursor-not-allowed shadow-lg"
          ...
          <div className="mt-6 text-center">
            <p className="text-gray-600">
              ¿Ya tienes cuenta?{' '}
              <Link href="/login" className="cursor-pointer font-semibold hover:underline" style={{ color: 'var(--color-rosa-principal)' }}>
                Inicia sesión
              </Link>
            </p>
          </div>
